...
It's important to set up the shield layers via the TRIM GUI and then edit the code in trim_helper.config_trim for your shield stack.
...
Use calc_transmitted_spectrum for calculating the transmitted proton spectrum. This can take a while. You can save the calculated scattering matrix and analysis functions will assume it's been saved under trim_config.SCATTERING_MATRIX_FILE.
